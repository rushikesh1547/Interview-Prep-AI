...
const LandingPage = () => {
  ...
  return (
    ...
    <div className="absolute w-[500px] h-[500px] bg-amber-200/20 blur-[65px]" />
      <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">        {/*Header*/}
        <header className="flex justify-between items-center mb-16">
          ...
          <div className="flex flex-col md:flex-row items-center ">
            <div className="w-full md:w-1/2 pr-4 mb-8:mb-0">
              <div className="flex items-center justify-left mb-2">
                <div className="flex item-center gap-2 text-[13px] text-amber-600 font-semibold bg-amber-100 px-3 py-1 rounded-full border border-amber-300">
